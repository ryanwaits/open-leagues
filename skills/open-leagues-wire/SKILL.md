...
2. Print the call: no-move, or add X at bid [lo, hi], and remaining FAAB.
   Name the source (spec or quantile).
3. If they ask why, `getAdviceReceipt` with the card's receipt id.
